        ...
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full md:w-1/2 px-4 mb-6 md:mb-0">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <div className="mb-4">
                <h3 className="text-xl font-semibold text-gray-800 mb-2">Was ist Lorem Ipsum?</h3>
              ...
              <div className="mb-4">
                <h3 className="text-xl font-semibold text-gray-800 mb-2">Wie kann ich den Support kontaktieren?</h3>
                <p className="text-gray-600">Sie können den Support kontaktieren, indem Sie das unten stehende Formular ausfüllen oder eine E-Mail an support@lawproject.com senden.</p>
              </div>
          ...
          <div className="w-full md:w-1/2 px-4">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h2 className="text-2xl font-bold text-gray-800 mb-4">Support-Anfrage senden</h2>
              <form>
                <div className="mb-4">
